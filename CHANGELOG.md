...
- 22c2d95 [TASK] Fix PHP style
- 2e6af32 [TASK] Add logger for deleted images

## BUGFIX

- 5d28177 [BUGFIX] prevent open_basedir warnings
- 67b5088 [BUGFIX] Fix coding styles
- 3f824e7 [BUGFIX] Fix error messages
- 6990dcb [BUGFIX] handle deleted files
- d6b0e6c [BUGFIX] Fixes #186: Add timestamp to force the javascript change
- 3efd3d5 [BUGFIX] Fixes #186: Inline image with link sometimes causes incorrect ordering of double
- 56e64f8 [BUGFIX] Regenerate images in backend view
- 9fb0b0e [BUGFIX] Fixes #244: RteImagePreviewRenderer throws warning with invalid HTML
- 5aaef60 [BUGFIX] Fixes #242: Call to a member function count() on null
- 7074226 [BUGFIX] Add missing property transformationKey to RteImagesDbHook
- 838610a [BUGFIX] Fix onclick event for select image modal
- 4d3be6a [BUGFIX] Loading RTE throws PHP Runtime Deprecation Notice

## MISC

- a62d0ab selection.getSelectedText() returns null is some circumstances
- 864756a fix #270: circumvent PHP < 7.4.4 bug with childNodes being NULL
- ebe4824 chore: update branch aliases
- 9a578b5 add TYPO3 badges to README
- 34bd1ae style: remove superfluous null check
- 000703e style: fix superfluous space before closing parenthesis
- bc30427 tests: fix PHP Fatal error:  Type of  testExtensionsToLoad must be array
- 9dee49b chore: remove superfluous is null check
- 60b55a4 GH-247: Unnecessary check for "data-*-override" removed, as these are only used within Javascript to document the checkbox state.
- 65663ac GH-112: Fix regex to find images
- 601e732 Rework ImageLinkRenderingController to match ImageRenderingController
- 908d149 GH-244: Sanitize HTML
- 720933a Fix class member variable name
- f78ae0e Update typo3/testing-framework requirement from ^6.16.7 to ^7.0.2
- 7307574 bugfix: incorrect parse indexes leading to dynamic image URL not to be resolved
- 913bed4 OPS-461: Update TER release info
- 5153eb4 NRS-2875: Update var name
- d12e7fc OPS-461: Change trigger and add infos to TER upload comment
- 14b96f4 OPS-461: Adapt action to our version syntax
- 8a17e56 OPS-461: Create Github action for publishing to TER
- ca9d0e2 Fix phpstan warnings
- 721f9e4 Optimize code
- 7136225 Fix CGL
- 4761fe2 Do not prepend site URL to embedded image in RTE
- 4fb6205 Do not prepend slash for data:image
- f4136ef Cleanup: remove commented out code
- 6c9c5c3 Fix name of testing.yml
- 67d86b3 Fix RteImageSoftReferenceParser
- 24321b7 Add functional tests
...
- 7bd5aa1 [BUGFIX] Set version in github action add-to-pipeline
- f4d3741 [BUGFIX] generate publicUrl from originalImageFile storage
- 1ceccac [BUGFIX] do not append "0" to getFileObject
...
- 58389ac OPS-461: Update TER release info
- 85f9fea NRS-2875: Update var name
- 02386b2 OPS-461: Change trigger and add infos to TER upload comment
- f0fe8ee OPS-461: Adapt action to our version syntax
- 586aaa5 OPS-461: Create Github action for publishing to TER
- 3c54089 Fix phpstan warnings
- 243f1ef Optimize code
- 6dcf4e9 Fix CGL
- edff497 Do not prepend site URL to embedded image in RTE
- 0486a61 Do not prepend slash for data:image
- 8377ce8 Fixes #56: Rework preview in backend
- c5d053e [FEAT] #56: Override preview for ctype text; show dummy images in preview
- 4040155 Add .attributes
- 1b06623 Fix output of alt and title attribute when overriden
- ed2dbd1 ensure the file processing is not deferred
- 1f95028 Update SECURITY.md
- c4255c5 Correction of typo + list indentation
- 708d944 Create pull_request_template.md
- e39bad0 Delete pull_request_template.md
- b20221e Delete pull_request_template.md
- 62a4b88 Create pull_request_template.md
- c9115fd Create pull_request_template.md
- 8024855 [DOCS] Change readme
