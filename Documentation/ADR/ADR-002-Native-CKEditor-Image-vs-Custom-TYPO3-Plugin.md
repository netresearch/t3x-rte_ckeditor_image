# ADR-002: Native CKEditor 5 Image Plugin vs Custom TYPO3 Image Plugin
...
**TypoScript Hook** (`setup.typoscript:12`):
...
```javascript
// Custom plugin integration (typo3image.js:349)
externalPlugins: {
  typo3image: {
...
**Created by** (`Classes/Database/RteImagesDbHook.php:18`):
...
**File**: `ImageRenderingController.php` (concept, actual file not shown)
...
The custom plugin currently lacks several WYSIWYG features present in native plugins:
...
2. **No Contextual Toolbar**: No balloon toolbar on image selection
   - Missing: `BalloonToolbar` integration
...
4. **No Image Styles**: No pre-defined alignment/sizing options
   - Missing: Style dropdown integration

**These are implementation gaps, not architectural limitations** — the custom plugin architecture supports these features, they just need to be implemented.
...
- TYPO3 FAL Documentation: https://docs.typo3.org/m/typo3/reference-coreapi/main/en-us/ApiOverview/Fal/
- TYPO3 RTE Configuration: https://docs.typo3.org/m/typo3/reference-coreapi/main/en-us/ApiOverview/Rte/
- CKEditor 5 Image Feature: https://ckeditor.com/docs/ckeditor5/latest/features/images/images-overview.html
- CKEditor 5 Plugin Development: https://ckeditor.com/docs/ckeditor5/latest/framework/architecture/plugins.html
